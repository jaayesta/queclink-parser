...
const getGV300 = raw => {
    ...
    try {
      data = Object.assign(data, {
        ...
        status: { //parsedData[24]
          ...
          sos: false,
          input: {
            '1': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(6,8)),4)[3] === '1',
            '2': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(6,8)),4)[2] === '1',
            '3': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(6,8)),4)[1] === '1',
            '4': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(6,8)),4)[0] === '1'
          },
          output: {
            '1': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(8,10)),3)[2] === '1',
            '2': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(8,10)),3)[1] === '1',
            '3': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[24],10).substring(8,10)),3)[0] === '1'
          },
          charge: parseFloat(parsedData[4]) > 5,
          state: utils.nHexDigit(parsedData[24],10).substring(4,6) != '' ? states[utils.nHexDigit(parsedData[24],10).substring(4,6)]: null
        },
        azimuth: parsedData[9] != '' ? parseFloat(parsedData[9]) : null,
        altitude: parsedData[10] != '' ? parseFloat(parsedData[10]) : null,
        datetime: parsedData[13] != '' ? utils.parseDate(parsedData[13]) : null,
  ...
  // GPS with AC100 Devices Connected
    ...
    data = Object.assign(data, {
      ...
      status: { //parsedData[24]
        ...
        sos: false,
        input: {
          '1': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(6,8)),4)[3] === '1',
          '2': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(6,8)),4)[2] === '1',
          '3': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(6,8)),4)[1] === '1',
          '4': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(6,8)),4)[0] === '1'
        },
        output: {
          '1': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(8,10)),3)[2] === '1',
          '2': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(8,10)),3)[1] === '1',
          '3': utils.nHexDigit(utils.hex2bin(utils.nHexDigit(parsedData[25],10).substring(8,10)),3)[0] === '1'
        },
        charge: parseFloat(parsedData[5]) > 5,
        state: utils.nHexDigit(parsedData[25],10).substring(4,6) != '' ? states[utils.nHexDigit(parsedData[25],10).substring(4,6)]: null
      },
      azimuth: parsedData[10] != '' ? parseFloat(parsedData[10]) : null,
      altitude: parsedData[11] != '' ? parseFloat(parsedData[11]) : null,
      datetime: parsedData[14] != '' ? utils.parseDate(parsedData[14]) : null,
  ...
  // General Info Report
    ...
    data = Object.assign(data, {
      ...
      lastFixUTCTime: parsedData[16] != '' ? utils.parseDate(parsedData[16]) : null,
...
const getGL300 = raw =>  {
  ...
  // General Info Report
    ...
    data = Object.assign(data, {
      ...
      lastFixUTCTime: parsedData[17] != '' ? utils.parseDate(parsedData[16]) : null,
      timezoneOffset: parsedData[22]
    });
  }
  ...
  else if(command[1] === 'GTEPN' || command[1] === 'GTEPF' || command[1] === 'GTBTC') {
    data = Object.assign(data, {
      alarm: getAlarm(command[1], null),
      loc: { type: 'Point', coordinates: [ parseFloat(parsedData[8]), parseFloat(parsedData[9])]},
      speed: parsedData[5] != '' ? parseFloat(parsedData[5]) : null,
