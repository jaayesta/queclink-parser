...
const parse = raw => {
  ...
  if (command[1] === 'GTFRI') {
    ...
    data = Object.assign(data, {
      ...
      mcc:
        parsedData[32] !== ''
          ? utils.latamMcc[parseInt(parsedData[32], 10)]
          : null,
      mnc:
        parsedData[33] !== ''
          ? utils.getMNC(parsedData[32], parsedData[33])
          : null,
    ...
    data = Object.assign(data, {
      ...
      mcc:
        parsedData[33] !== ''
          ? utils.latamMcc[parseInt(parsedData[33], 10)]
          : null,
      mnc:
        parsedData[34] !== ''
          ? utils.getMNC(parsedData[33], parsedData[34])
          : null,
